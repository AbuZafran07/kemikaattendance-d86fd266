...
DROP TRIGGER IF EXISTS trg_auto_insert_attendance_lupa_absen ON public.leave_requests;
CREATE TRIGGER trg_auto_insert_attendance_lupa_absen
AFTER UPDATE ON public.leave_requests
FOR EACH ROW
EXECUTE FUNCTION public.auto_insert_attendance_on_lupa_absen();
